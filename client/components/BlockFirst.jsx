...
const BlockFirst = () => {
	return (
		<div className="block-narrow block-first">
			<div className="block-first-left col-mobile-12 col-xs-6">
				<div className="block-first-left-text col-md-10">
					<h3>We Match Freelancers With Cause + Skills</h3>
			...
			<div className="block-first-right col-mobile-12 col-xs-6">
				<table>
					<tr>
